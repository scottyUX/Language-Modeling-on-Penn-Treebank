...
if __name__ == '__main__':
    ...
    train_dataset, val_dataset, test_dataset, tokenizer = preprocess_data(vocab_size=5000)
    ...
    model = TransformerLM(vocab_size, d_model=128, n_head=4, n_layer=2).to(device)
